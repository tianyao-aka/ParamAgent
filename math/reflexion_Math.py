...
def run_reflexion(
    ...
    qa_agent = None
    print("Running Reflexion with MathQA")
        ...
        try:
            ...
            while cur_pass < pass_at_k and not is_solved:
                ...
                while cur_func_impl is None:
                    cur_func_impl = gen.func_impl(item["problem"], model, "simple",temperature=0.2)
                    fail_cnt += 1
                    if fail_cnt > 3:
                        print("Failed to generate a valid implementation after 3 attempts.")
                        break
                ...
                while cur_iter < max_iters:
                    ...
                    reflection = gen.self_reflection(
                        item["problem"], cur_func_impl, cur_feedback, model)
                    ...
                    while new_func_impl is None:
                        new_func_impl = gen.func_impl(
                            item["problem"],model, "reflexion",prev_answers=cur_func_impl,feedback=cur_feedback,
