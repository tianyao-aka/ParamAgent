            ...
            while cur_pass < pass_at_k and not is_solved:
                ...
                while cur_iter < max_iters:
                    ...
                    div_reflections = gen.self_reflection_diverse(
                        item["problem"], cur_func_impl, cur_feedback, model,diverse_reflections).split('\n')
                    # print (f"div reflections: {div_reflections}")
                    ...
                    while ref_id < min(len(div_reflections), 2):
                        # print (f"ref id: {ref_id}, min len: {len(div_reflections)}")
                        del exe
                        exe = executor_factory(lang='math', is_leet=is_leetcode)
