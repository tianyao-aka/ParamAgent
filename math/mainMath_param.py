...
""")
    ...
    if len(args.insight_json_path)>3:
        ...
        if 'pitfalls_high_temp' not in insight_json_file[0]:
            if MathPitfallAgent is not None:
                ...
                print("WARNING: MathPitfallAgent not available, setting to None")
                Math_agent = None
        else:
            Math_agent = None
